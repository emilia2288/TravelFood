...
namespace TravelFood.Account
{
    public partial class RegisterExternalLogin : System.Web.UI.Page
    {
        ...
        private void ProcessProviderResult()
        {
            ...
            #region Add By Emilia

            Response.Cookies["AccessToken"].Value = authResult.ExtraData["accesstoken"].ToString();
            Response.Cookies["FacebookID"].Value = authResult.ProviderUserId;
            //FriendsData.GetFacebookFriends(Request.Cookies["FacebookID"].Value, Request.Cookies["AccessToken"].Value);
